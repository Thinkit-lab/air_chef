...
class _MySavedCardsState extends State<MySavedCards> {
  ...
  final List<Map> collections = [
    {"name": "William Jones ", "email": 'wjones2@gmail.com', "card_no": "Card No: 4156 10** **** 1200", 
    "expiry": "Exp. Date: 03/19, 09/25"},
    {"name": "Mikie", "email": 'mikie43@gmail.com', "card_no": "Card No: 0022 3002 5644 8700", 
    "expiry":"Exp. Date: 03/19, 09/25"},
  ];
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          SizedBox(height: 5,),
              ...
              textAlign: TextAlign.left,
                 ...
                 Spacer(),
                 Column(children: [
                   Image(image: AssetImage('assets/images/Fill 1.png'),),
                   SizedBox(height: 10,),
                    Image(image: AssetImage('assets/images/Fill 2.png'),),
                 ],),
                           ],
                         ),
                       );
