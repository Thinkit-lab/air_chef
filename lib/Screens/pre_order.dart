          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Container(
                    width: 70,
                    height: 40,
                    decoration: BoxDecoration(color: Color(0xffE9E2DB), 
              ...
              Container(
                    width: 70,
                    height: 40,
                    decoration: BoxDecoration(color: Color(0xff7E7B7B), 
                    borderRadius: BorderRadius.circular(8),),
                child: Center(
                  child: Text('2:00 pm',
                  style: GoogleFonts.nunitoSans(
                       textStyle: const TextStyle(color:  Colors.white, letterSpacing: .5, fontSize: 14, fontWeight: FontWeight.bold),
                             ),),
                ),
              ),
              Container(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.circle, color: Color(0xff00C393), size: 10,),
                      SizedBox(width: 5,),
                      Text('Available',
                  style: GoogleFonts.nunitoSans(
                  ...
                  Row(
                    children: [
                      Icon(Icons.circle, color: Color(0xff40054F),size: 10,),
                      SizedBox(width: 5,),
                      Text('Not Available',
                  style: GoogleFonts.nunitoSans(
                       textStyle: const TextStyle(color:  Color(0xff40054F), letterSpacing: .5, fontSize: 14,),
                             ),),
                    ],
                  ),
                Row(
